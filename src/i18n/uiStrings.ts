...
const zh = {
  ...
  // ── Header / navigation ─────────────────────────────────────────────
  'nav.backHome': '回到首頁',
  'nav.subtitle': '智慧居家復健教練',
  'nav.tabsAria': '主導覽列',
  'nav.dashboard': '復健總覽',
  'nav.exercises': '動作與課表',
  'nav.prescriptions': '我的處方',
  ...
  // ── Dashboard ───────────────────────────────────────────────────────
  'dash.heroTitle': '全方位復健總覽',
  'dash.heroSub':
    '即時追蹤關節活動度與動作節奏，在家或辦公桌前完成處方復健。影像全程留在這台裝置上。',
  ...
  'region.shoulder': '肩關節與旋轉肌群',
  'region.knee': '膝關節與股四頭肌',
  'region.hip': '髖關節與臀肌群',
  'region.elbow': '手肘與前臂肌群',
  'region.spine': '脊椎中軸與核心',
  'region.ankle': '腳踝與小腿肌群',

  'anatomy.aria': '人體解剖部位復健選擇器',
  'anatomy.tag': '全身關節復健地圖',
  'anatomy.title': '選擇欲復健或訓練的身體部位',
  'anatomy.sub': '以視覺化關節圖表導覽各部位處方動作與肌群',
  'anatomy.interactiveHint': '點擊人體肌肉區域或卡片以進入該部位專屬面板',
  'anatomy.activeBadge': '已上線處方',
  'anatomy.availableBadge': '已就緒',
  'anatomy.upcomingBadge': '研發中',
  'anatomy.targetMuscles': '核心肌群：',
  'anatomy.viewRegion': '進入專區',
  'anatomy.prescribedCount': '{n} 項處方動作',
  'anatomy.availableCount': '{n} 項可訓練動作',
  'anatomy.upcomingCount': '{n} 項規劃中',
  'anatomy.totalExercises': '共 {n} 項動作',

  // ── Region Detail Modal / Surface ──────────────────────────────────
  'regionModal.aria': '{name} 專屬復健專區',
  'regionModal.close': '關閉部位專區',
  'regionModal.backToFullBody': '← 返回全身部位選擇',
  'regionModal.prescribedTitle': '已上線臨床處方動作',
  'regionModal.prescribedSub': '具備即時姿態追蹤與代償防護的標準動作',
  'regionModal.availableTitle': '已就緒可訓練動作',
  'regionModal.availableSub': '具備即時姿態追蹤與代償防護的標準動作',
  'regionModal.upcomingTitle': '規劃中動作路線',
  'regionModal.upcomingSub': '後續版本即將推出之運動學追蹤項目',
  'regionModal.routinesTitle': '部位推薦組合課表',
  'regionModal.routinesSub': '結合多項動作的完整訓練組合',
  'regionModal.quickStart': '開始訓練',
  'regionModal.exploreAll': '前往動作資料庫查看全部',
  'regionModal.noPrescribed': '此部位之處方動作正在進行運動學校準與文獻實證',
  'regionModal.noAvailable': '此部位之動作正在進行運動學校準與臨床驗證',
  'regionModal.statusActive': '包含即時視覺追蹤處方',
  'regionModal.statusAvailable': '具備即時視覺追蹤',
  'regionModal.statusUpcoming': '運動學建模中',

  // ── My Prescriptions Planner ───────────────────────────────────────
  'rx.tag': '個人專屬復健課表',
  'rx.heroTitle': '我的復健處方與時間表',
  'rx.heroSub': '依照醫師或治療師建議自訂復健進程。支援多項動作平行進行或分階段推進。',
  'rx.createBtn': '＋ 新增處方項目',
  'rx.emptyTitle': '尚未建立個人處方項目',
  'rx.emptySub': '您可以從動作庫將可訓練的動作加入您的處方清單，或點擊上方按鈕新增項目。',
  'rx.metricActive': '平行進行中動作',
  'rx.metricQueued': '後續階段排程',
  'rx.metricDays': '每週目標天數',
  'rx.metricCompleted': '已達成處方目標',
  'rx.trackActive': '當前執行階段（平行進行中）',
  'rx.trackActiveSub': '此階段內的所有動作可每日同步執行',
  'rx.trackQueued': '後續階段排程（等待中）',
  'rx.trackQueuedSub': '完成當前階段或待醫師評估後啟動',
  'rx.trackCompleted': '已達成處方目標',
  'rx.trackCompletedSub': '已圓滿完成的歷史復健階段',
  'rx.statusActive': '進行中',
  'rx.statusQueued': '排程中',
  'rx.statusCompleted': '已完成',
  'rx.durationWeeks': '{n} 週目標',
  'rx.weekProgress': '第 {current} / {total} 週',
  'rx.setsPerDay': '每日 {n} 組',
  'rx.daysPerWeek': '每週 {n} 天',
  'rx.startBtn': '開始訓練',
  'rx.activateNow': '移入進行中',
  'rx.markDone': '標記為完成',
  'rx.edit': '編輯',
  'rx.delete': '移除',
  'rx.inPlanBadge': '已在處方中',
  'rx.addToPlan': '＋ 加入我的處方',
  'rx.addedToast': '已成功加入您的處方清單',
  'rx.dashTodayRx': '今日個人處方訓練',
  'rx.dashTodayRxSub': '根據您的個人時間表排定之目標動作',
  'rx.dashNoRxTitle': '尚未設定個人處方',
  'rx.dashNoRxSub': '前往「我的處方」頁面為自己排定個人化訓練進程與週數',
  'rx.dashGoToPlan': '設定我的處方課表 ›',

  // ── Timeline Visualizer ─────────────────────────────────────────────
  'timeline.title': '復健處方時間軸進程圖',
  'timeline.sub': '整合進行中平行動作、後續排程與已完成階段的跨週度進程圖',
  'timeline.legendCurrent': '進行中平行動作',
  'timeline.legendQueued': '後續排程階段',
  'timeline.legendCompleted': '已達成階段',
  'timeline.currentWeekMarker': '本週進度',
  'timeline.weekLabel': '第 {n} 週',
  'timeline.emptyTimeline': '加入處方動作後，將自動生成多階段復健進程視覺化圖表。',

  // ── Prescription Editor Modal ───────────────────────────────────────
  'rxModal.addTitle': '新增處方動作項目',
  'rxModal.editTitle': '編輯處方動作項目',
  'rxModal.selectExercise': '選擇復健動作（限已就緒項目）',
  'rxModal.customTitle': '處方自訂標籤 / 階段名稱（選填）',
  'rxModal.customTitlePlaceholder': '例如：術後第一階段保護性訓練',
  'rxModal.duration': '執行週數 (1–12 週)',
  'rxModal.dailySets': '每日目標組數',
  'rxModal.weeklyDays': '每週訓練天數',
  'rxModal.scheduleMode': '排程進度階段',
  'rxModal.modeActive': '平行進行中（與當前動作同步執行）',
  'rxModal.modeQueued': '後續階段排程（等待當前階段完成後開始）',
  'rxModal.notes': '醫師 / 物理治療師囑咐要點',
  'rxModal.notesPlaceholder': '例如：平舉不得超過 90 度，若有尖銳刺痛立即停止',
  'rxModal.cancel': '取消',
  'rxModal.save': '儲存處方',
} as const
...
const en: Record<StringKey, string> = {
  ...
  'nav.subtitle': 'Intelligent Home Rehabilitation Coach',
  ...
  // ── Dashboard ───────────────────────────────────────────────────────
  'dash.heroTitle': 'Rehabilitation Overview',
  'dash.heroSub':
    'Track joint mobility angle and movement tempo in real time, and complete your prescribed rehabilitation at home or at your desk. Video stays on this device throughout.',
  ...
  'rdetail.delete': 'Delete menu',
  'rdetail.edit': 'Edit menu',
  ...
  'builder.thumbTitle': 'Menu cover image',
  'builder.thumbDesc':
  ...
  // ── Anatomy & Region Selector ───────────────────────────────────────
  'region.shoulder': 'Shoulder & Rotator Cuff',
  'region.knee': 'Knee & Quadriceps',
  'region.hip': 'Hip & Gluteal Complex',
  'region.elbow': 'Elbow & Forearm',
  'region.spine': 'Spine & Core Posture',
  'region.ankle': 'Ankle & Lower Leg',

  'anatomy.aria': 'Interactive anatomical body rehabilitation selector',
  'anatomy.tag': 'Full-Body Musculoskeletal Rehab Map',
  'anatomy.title': 'Select a Target Body Region',
  'anatomy.sub': 'Visual guide to targeted movement prescriptions and joint biomechanics',
  'anatomy.interactiveHint': 'Click on anatomical muscle groups or cards to open the dedicated region dashboard',
  'anatomy.activeBadge': 'Available',
  'anatomy.availableBadge': 'Available',
  'anatomy.upcomingBadge': 'In Development',
  'anatomy.targetMuscles': 'Target muscles: ',
  'anatomy.viewRegion': 'Explore Region',
  'anatomy.prescribedCount': '{n} Prescribed Exercises',
  'anatomy.availableCount': '{n} Available Exercises',
  'anatomy.upcomingCount': '{n} In Development',
  'anatomy.totalExercises': '{n} total movements',

  // ── Region Detail Modal / Surface ──────────────────────────────────
  'regionModal.aria': '{name} Rehabilitation Dashboard',
  'regionModal.close': 'Close region dashboard',
  'regionModal.backToFullBody': '← Back to full body map',
  'regionModal.prescribedTitle': 'Active Prescribed Exercises',
  'regionModal.prescribedSub': 'Calibrated movements with live pose tracking and compensation guards',
  'regionModal.availableTitle': 'Available Coached Exercises',
  'regionModal.availableSub': 'Calibrated movements with live pose tracking and compensation guards',
  'regionModal.upcomingTitle': 'Roadmap & Future Movements',
  'regionModal.upcomingSub': 'Kinematics models currently under verification',
  'regionModal.routinesTitle': 'Targeted Multi-Exercise Routines',
  'regionModal.routinesSub': 'Comprehensive movement station sequences',
  'regionModal.quickStart': 'Start Session',
  'regionModal.exploreAll': 'Explore in Exercise Library',
  'regionModal.noPrescribed': 'Exercises for this region are undergoing kinematic modeling and clinical verification',
  'regionModal.noAvailable': 'Exercises for this region are undergoing kinematic modeling and clinical verification',
  'regionModal.statusActive': 'Live Real-Time Coaching',
  'regionModal.statusAvailable': 'Live Real-Time Coaching',
  'regionModal.statusUpcoming': 'Kinematic Modeling Phase',

  // ── My Prescriptions Planner ───────────────────────────────────────
  'rx.tag': 'Personal Prescription Plan',
  'rx.heroTitle': 'My Prescriptions & Timeline',
  'rx.heroSub': 'Customize your rehab progression per clinician instructions. Run movements in parallel or sequentially across recovery stages.',
  'rx.createBtn': '＋ Add Prescription',
  'rx.emptyTitle': 'No prescriptions added yet',
  'rx.emptySub': 'Add available exercises from the library to your prescription list, or create one below.',
  'rx.metricActive': 'Active In-Parallel',
  'rx.metricQueued': 'Queued Next Phases',
  'rx.metricDays': 'Target Days/Week',
  'rx.metricCompleted': 'Completed Goals',
  'rx.trackActive': 'Active Phase (In Parallel)',
  'rx.trackActiveSub': 'All movements in this track can be performed daily',
  'rx.trackQueued': 'Queued Stages (Upcoming)',
  'rx.trackQueuedSub': 'Scheduled to start after current active phases',
  'rx.trackCompleted': 'Completed Milestones',
  'rx.trackCompletedSub': 'Finished historical recovery goals',
  'rx.statusActive': 'ACTIVE',
  'rx.statusQueued': 'QUEUED',
  'rx.statusCompleted': 'COMPLETED',
  'rx.durationWeeks': '{n} Weeks Goal',
  'rx.weekProgress': 'Week {current} of {total}',
  'rx.setsPerDay': '{n} sets/day',
  'rx.daysPerWeek': '{n} days/week',
  'rx.startBtn': 'Start Exercise',
  'rx.activateNow': 'Activate Now',
  'rx.markDone': 'Mark Completed',
  'rx.edit': 'Edit',
  'rx.delete': 'Remove',
  'rx.inPlanBadge': 'In My Plan',
  'rx.addToPlan': '＋ Add to My Prescriptions',
  'rx.addedToast': 'Successfully added to your prescription plan',
  'rx.dashTodayRx': "Today's Personal Prescriptions",
  'rx.dashTodayRxSub': 'Target movements scheduled in your personal timeline',
  'rx.dashNoRxTitle': 'No personal prescriptions set',
  'rx.dashNoRxSub': 'Visit My Prescriptions to schedule custom weekly progression for your recovery',
  'rx.dashGoToPlan': 'Set Up My Prescription Plan ›',

  // ── Timeline Visualizer ─────────────────────────────────────────────
  'timeline.title': 'Prescription Progression Timeline',
  'timeline.sub': 'Visual map spanning active parallel exercises, queued roadmap stages, and completed milestones',
  'timeline.legendCurrent': 'Active In-Parallel',
  'timeline.legendQueued': 'Queued Next Stage',
  'timeline.legendCompleted': 'Completed Milestone',
  'timeline.currentWeekMarker': 'Current Week',
  'timeline.weekLabel': 'Week {n}',
  'timeline.emptyTimeline': 'Add prescription movements to generate your multi-stage recovery timeline.',

  // ── Prescription Editor Modal ───────────────────────────────────────
  'rxModal.addTitle': 'Add Prescription Movement',
  'rxModal.editTitle': 'Edit Prescription Movement',
  'rxModal.selectExercise': 'Select Movement (Available only)',
  'rxModal.customTitle': 'Custom Label / Stage Name (Optional)',
  'rxModal.customTitlePlaceholder': 'e.g., Post-Op Stage 1 Protection',
  'rxModal.duration': 'Duration (1–12 Weeks)',
  'rxModal.dailySets': 'Daily Target Sets',
  'rxModal.weeklyDays': 'Weekly Target Days',
  'rxModal.scheduleMode': 'Schedule Track',
  'rxModal.modeActive': 'Active (Run in parallel now)',
  'rxModal.modeQueued': 'Queued (Start in next phase)',
  'rxModal.notes': 'Clinician / PT Notes',
  'rxModal.notesPlaceholder': 'e.g., Do not exceed 90° elevation, stop if sharp pain occurs',
  'rxModal.cancel': 'Cancel',
  'rxModal.save': 'Save Prescription',
}
